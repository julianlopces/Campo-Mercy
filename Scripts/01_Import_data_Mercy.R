...
data <- data %>%
  mutate(ingresos_mes = case_when(
    ...
    ID == "30cbc6b2-3d31-4377-9d93-028808c105d9" & ingresos_mes == "17000000" ~ "1700000",
    TRUE ~ ingresos_mes),
    ingresos_semana = case_when(
      ID == "30cbc6b2-3d31-4377-9d93-028808c105d9" & ingresos_semana == "9500000" ~ "950000",
      TRUE ~ ingresos_semana
    ),
    gasto_arriendo = case_when(
      ID == "30cbc6b2-3d31-4377-9d93-028808c105d9" & gasto_arriendo == "18000000" ~ "1800000",
      TRUE ~ gasto_arriendo
    ),
